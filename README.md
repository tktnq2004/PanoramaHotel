...
- **Nguồn ảnh Panorama (Khó khăn và tốn nhiều thời gian nhất)** nguồn ảnh trên GoogleMap đều có bản quyền không thể sử dụng. Skybox AI cần trả phí để có thể download. Các nguồn ảnh miễn phí như Poly Haven, Kuula.co chỉ có những ảnh đơn lẻ, ảnh không liên kết với nhau. Dẫn đến rất khó khăn cho việc hoàn thiện tính logic của các hotspot đến chuyển panorama. 
