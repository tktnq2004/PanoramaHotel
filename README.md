...
- **Nguồn ảnh Panorama** nguồn ảnh trên GoogleMap đều có bản quyền không thể sử dụng. Skybox AI cần trả phí để có thể download. Các nguồn ảnh miễn phí như Poly Haven, Kuula.co chỉ có những ảnh đơn lẻ, ảnh không liên kết với nhau. Dẫn đến khó cho việc hoàn thiện tính logic của app. 
...
## 6. Hướng phát triển nếu có thêm thời gian
...
## 7. Giải thích giải pháp đã lựa chọn
